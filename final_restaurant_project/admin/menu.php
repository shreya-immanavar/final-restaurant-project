...
<head>
    ...
    <style>
        ...
        .content-header h2 { font-family: var(--font-heading); margin:0;color:#333}
        .add-btn{background: linear-gradient(135deg, var(--color-secondary), var(--color-secondary-light));color:#fff !important;text-decoration:none !important;padding:12px 24px;border-radius:25px;font-weight:500;font-size:14px;letter-spacing:0.5px;transition:all 0.3s ease;position:relative;overflow:hidden;border:1px solid rgba(255,255,255,0.2);box-shadow:0 4px 15px rgba(40,167,69,0.3)}
        ...
        .add-btn:hover{background: linear-gradient(135deg, var(--color-secondary), var(--color-secondary-light));color:#fff !important;text-decoration:none !important;transform:translateY(-3px);box-shadow: 0 8px 25px rgba(212,175,55,0.4);border-color:rgba(255,255,255,0.4)}
        ...
        .menu-table{width:100%;background: var(--color-surface);border-radius:10px;overflow:hidden;box-shadow:0 3px 15px rgba(0,0,0,0.1);border-collapse:collapse}
        ...
        .restaurant-badge{display:inline-block;background: linear-gradient(135deg, rgba(212,175,55,0.8), rgba(212,175,55,0.6));color:#fff;padding:4px 8px;border-radius:12px;font-size:11px;font-weight:500;margin-top:4px}
        .price-tag{font-weight:700;color: var(--color-primary);font-size:16px}
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <?php else: ?>
                            <div class="item-image" style="background: var(--color-surface-soft);display:flex;align-items:center;justify-content:center;color:#666;font-size:20px;">🍽️</div>
                        <?php endif; ?>
                    </td>
                    <td>
