...
<head>
    ...
    <style>
        ...
        .dashboard-header h1 { font-family: var(--font-heading); font-size: 2.5em;
            font-weight: 700;
        ...
        .content-header h2 { font-family: var(--font-heading); margin: 0;
            color: var(--color-text);
            font-size: 1.8em;
            font-weight: 600;
        }
        ...
        @media (max-width: 768px) {
            ...
            .dashboard-header h1 { font-family: var(--font-heading); font-size: 2em;
            }
