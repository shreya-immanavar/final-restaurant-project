    ...
    <div class="wrap">
        ...
        <div class="restaurant-header">
            ...
            <div class="restaurant-info">
                ...
                <a href="<?php echo BASE_URL; ?>restaurants.php" class="btn btn-secondary">← Back to Restaurants</a>
            </div>
        </div>
                ...
                <div class="menu-grid">
                    ...
                    <div class="menu-item-card">
                        ...
                        <div class="menu-item-info">
                            ...
                            <a href="<?php echo BASE_URL; ?>cart.php?add=<?php echo $item['item_id']; ?>" class="btn btn-primary">Add to Cart</a>
                        </div>
                    </div>
                    <?php endwhile; ?>
                </div>
