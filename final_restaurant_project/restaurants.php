        ...
        <div class="restaurants-grid">
            ...
            <div class="restaurant-card">
                ...
                <div class="restaurant-info">
                    ...
                    <a href="<?php echo BASE_URL; ?>restaurant.php?id=<?php echo $restaurant['restaurant_id']; ?>" class="btn btn-primary">View Menu</a>
                    <a href="<?php echo BASE_URL; ?>reservation/book.php" class="btn btn-outline">Make a Reservation</a>
                </div>
            </div>
