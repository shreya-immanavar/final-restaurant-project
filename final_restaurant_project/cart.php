    ...
    <div class="wrap">
        ...
        <?php if(!empty($_SESSION['cart'])): ?>
            <div class="cart-actions">
                <a href="<?php echo BASE_URL; ?>cart.php?clear=1" class="btn btn-secondary" onclick="return confirm('Clear all items from cart?')">Clear Cart</a>
            </div>
            ...
            <form method="post" class="cart-form">
                <div class="cart-table">
                    ...
                    <div class="cart-row">
                        ...
                        <div class="action">
                            <a href="<?php echo BASE_URL; ?>cart.php?remove=<?php echo $item_id; ?>" class="btn-remove" onclick="return confirm('Remove this item?')">Remove</a>
                        </div>
                    </div>
                ...
                <div class="cart-buttons">
                    <a href="<?php echo BASE_URL; ?>restaurants.php" class="btn btn-secondary">Continue Shopping</a>
                    <button type="submit" name="update_cart" class="btn btn-secondary">Update Quantities</button>
                    <a href="<?php echo BASE_URL; ?>checkout.php" class="btn btn-primary">Proceed to Checkout</a>
                </div>
            </form>
        ...
        <?php else: ?>
            <div class="empty-cart">
                ...
                <a href="<?php echo BASE_URL; ?>restaurants.php" class="btn btn-primary">Browse Restaurants</a>
            </div>
        <?php endif; ?>
    </div>
</section>
